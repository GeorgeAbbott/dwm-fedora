...
enum { SchemeNorm, SchemeSel, SchemeStatus, SchemeTagsSel, SchemeTagsNorm, SchemeInfoSel, SchemeInfoNorm, SchemeUrg, SchemeLast }; /* color schemes */
...
drawbar(Monitor *m)
{
	...
	if (m == selmon) { /* status is only drawn on selected monitor */
		drw_setscheme(drw, scheme[SchemeStatus]); // modified manually in accordance with dwm.c.colorbar.rej
...
setup(void)
{
    ...
    /** For urgent - might be wrong **/
    //scheme[SchemeUrg].border = drw_
